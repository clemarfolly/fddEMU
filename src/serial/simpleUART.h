...
class UART0 : public UART
{
  public:
    ...
    {
        usb_cdc_loop();
        return !RingBuffer_IsEmpty(&USBtoUSART_Buffer);
    };
#endif // defined (__ATmega32U4__)
};
